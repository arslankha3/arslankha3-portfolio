      ...
      >
        <div className="flex flex-col max-w-[380px] items-start">
          <div>
            ...
            <motion.h1
              variants={childVariants}
              className="text-small text-left flex flex-col items-start"
            >
              Hi there,
              <div className="text-small flex gap-x-2 items-center">
                my name is
                <span className="text-primary">Arsalan Ahmed Khatri</span>
              </div>
            </motion.h1>
            <motion.p
              variants={childVariants}
